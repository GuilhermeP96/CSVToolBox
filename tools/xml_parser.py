...
class XMLParserTool(ctk.CTkFrame):
    ...
    def create_widgets(self):
        ...
        root_hint = ctk.CTkLabel(
            ...
            text="Use * para todos ou nome especçifico (ex: oferta, item, registro)",
        ...
        mode_hint = ctk.CTkLabel(
            ...
            text="auto: detecta | flat: só folhas | nested: mantçem hierarquia",
    ...
    def detect_xml_structure(self, filepath):
        ...
        try:
            ...
            # Encontrar elementos repetidos (provçaveis registros)
            ...
            # Elemento mais frequente provavelmente çe o registro
            ...
            if child_counts:
                ...
                if count > 1:
                    ...
                    self.log_text.insert("end", f"  é→ Sugestão: usar '{most_common}' como elemento\n")
    ...
    def parse_element(self, element):
        ...
        """Converte um elemento XML em dicionçario"""
        ...
        for child in element:
            ...
            # Se tem filhos, çe complexo - pegar só texto ou recursivo
            ...
            if len(child) == 0:
                ...
                # Modo nested: criar sub-dicionçario
    ...
    def flatten_dict(self, d, parent_key='', sep='_'):
        ...
        """Achata um dicionçario aninhado"""
    ...
    def _execute_conversion(self, input_file, output_file):
        ...
        try:
            ...
            if total_elements == 0:
                ...
                messagebox.showwarning("Aviso", f"Nenhum elemento '{element_name}' encontrado não XML!")
            ...
            self.status_label.configure(text=f"Concluçido! {len(df)} registros salvos.")

            

            self.log_text.insert("end", f"\né✅ Conversão concluçida!\n")
